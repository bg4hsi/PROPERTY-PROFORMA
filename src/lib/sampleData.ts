...
const row = (id: string, name: string, kind: "销售" | "给政府" | "自持酒店" | "自持商业", buildingArea: number, governmentArea: number, saleArea: number, salePrice: number, unitCost: number) => ({
  ...
  ...(kind.startsWith("自持") ? { holding: { ...holding } } : {})
});
...
export const sampleScenario: Scenario = {
  ...
  project: {
    ...
    vatRate: 0.15, managementRate: 0.02, salesRate: 0.05, shareholderInterestRate: 0.08, deliveryMonth: 24, phase2StartMonth: 25, phase2DeliveryMonth: 48, trialOperationMonths: 3,
    collectionDownPaymentRate: .3, collectionMonthlyRate: .05, collectionPreDeliveryPaymentRate: .8, collectionTailInstallmentMonths: 3,
    fullPaymentRate: 0, fullPaymentDiscountRate: 0,
  ...
  rows: [
    { ...row("apt", "公寓（销售）", "销售", 18000, 0, 14040, 19000, 5508), unitCount: 250, collection: collection(1, 24, 250, 18, .3, .05, 3) },
    ...
    { ...row("street-sale", "商业街（销售）", "销售", 4200, 0, 4200, 35000, 5933), unitCount: 42, collection: collection(6, 24, 42, 3, .5, .1, 6) },
