...
export const sampleScenario: Scenario = {
  ...
  project: {
    ...
    vatRate: 0.15, managementRate: 0.02, salesRate: 0.05, deliveryMonth: 24, trialOperationMonths: 3,
    hotelAverageDailyRate: 800, commercialMonthlyRent: 150, hotelOccupancyRate: .7, commercialOccupancyRate: .85,
